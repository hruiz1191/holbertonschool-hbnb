...
class HBnBFacade:
    ...
    def create_user(self, data):
        ...
        if existing_user:
            print(f"[DEBUG] Usuario con email {data['email']} ya existe. No se puede registrar nuevamente.")
        ...
        # Confirmar que el usuario realmente fue guardado
        saved_user = self.user_repo.get_user_by_email(user.email)
        print(f"[DEBUG] Usuario guardado en repo: {saved_user.to_dict() if saved_user else 'None'}")
    ...
    def create_place(self, data):
        ...
        for amenity_id in data.get('amenities', []):
            ...
            if amenity:
                ...
                print(f"Amenity {amenity_id} no encontrado. Será ignorado.")
