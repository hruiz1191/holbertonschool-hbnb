...
class HBnBFacade:
    ...
    def create_place(self, data):
        ...
        if not owner:
            raise ValueError("[FACADE] Error: Propietario no encontrado")
        ...
        print(f"[FACADE] Lugar creado exitosamente: {place.title}")
    ...
    def update_place(self, place_id, user_id, data):
        ...
        if not place or place['owner']['id'] != user_id:
            print("[FACADE] Error: Solo el dueño puede actualizar el lugar")
            return None
    ...
    def delete_place(self, place_id, user_id):
        ...
        place = self.get_place(place_id)
        if not place or place['owner']['id'] != user_id:
            print("[FACADE] Error: Solo el dueño puede eliminar el lugar")
            return False
